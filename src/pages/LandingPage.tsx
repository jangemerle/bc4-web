...
function PromoBanner() {
  return (
    ...
    >
      <span className="opacity-90">Now shipping</span>
      <span className="mx-2 font-bold">Kvalt v2 — Characters & Theming</span>
      <span
      ...
      <div className="mx-auto max-w-[1280px] px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 max-w-[600px]">
          ...
          >
            ...
            <span
              className="text-sm font-medium flex items-center gap-1 px-3 py-1.5 rounded-full cursor-pointer"
              style={{
                border: '1px solid var(--color-border-strong)',
                color: 'var(--color-on-surface)',
              }}
            >
              Kvalt v2 <ArrowRight size={14} />
            </span>
          </motion.div>
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ type: 'spring', visualDuration: 0.5, bounce: 0.05, delay: 0.08 }}
            className="text-[42px] lg:text-[52px] leading-[1.08] font-bold tracking-tight mb-6"
            style={{
              fontFamily: 'var(--font-display)',
              color: 'var(--color-on-surface)',
            }}
          >
            The most expressive, motion-driven design system for SaaS
          </motion.h1>
          ...
          <motion.p
            ...
            style={{ color: 'var(--color-on-surface-subtle-1)' }}
          >
            25 production-ready components with spring animations, HSLUV color science,
            dark mode, and WCAG AA accessibility. Built for teams that ship fast.
          </motion.p>

          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ type: 'spring', visualDuration: 0.4, bounce: 0.05, delay: 0.24 }}
...
const TECH_LOGOS = [
  'React 19', 'TypeScript', 'Tailwind CSS', 'Motion 12', 'Vite 8', 'Lucide Icons',
  'HSLUV Colors', 'WCAG AA', 'Figma Sync', 'Dark Mode',
];
...
const SHOWCASE_CARDS: {
...
}[] = [
  {
    ...
    description: '6 HSLUV palettes × 12 shades, Inter + Borna fonts, 9 shadow tokens, 4px spacing grid. Every value derived from a single source of truth.',
    pattern: 'scale',
    patternSeed: 42,
    color: '#7DDB85',
    label: 'Scale',
  ...
  {
    title: 'Components',
    subtitle: '25 Production-Ready',
    tags: ['Accessible', 'Animated', 'Themed'],
    description: 'From Button to DataTable, each component ships with full variant coverage, keyboard nav, spring animations, and dark mode built in.',
    pattern: 'add',
    patternSeed: 137,
    color: '#84AAE6',
    label: 'Add',
  },
  {
    ...
    tags: ['Snappy', 'Default', 'Playful'],
    description: 'Semantic motion tokens: springs for spatial moves, easings for state fades, a global speed dial. Alive, not hyperactive.',
      ...
      <div className="mx-auto max-w-[1280px] px-6">
        <FadeInSection>
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)', color: 'var(--color-on-surface)' }}
          >
            Experience Kvalt — design systems, but alive
          </h2>
          <p
...
const USE_CASES = [
  {
    ...
    description: 'Tables, forms, modals, and navigation — the bread and butter of operational SaaS, designed for dense data.',
  },
  {
    icon: Component,
    title: 'Design System Teams',
    description: 'A fully documented, token-driven architecture that scales. Export specs for your FE team to transform.',
  },
  {
    icon: Figma,
    title: 'Figma-to-Code',
    description: 'Built from real Figma designs with a complete token mapping table. Paste a frame, get production components.',
  },
  {
    icon: Sparkles,
    title: 'Branded Experiences',
    description: 'Character theming swaps 53 CSS variables at once. Same components, completely different personality.',
  },
];
      ...
      <div className="mx-auto max-w-[1280px] px-6">
        <FadeInSection>
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)', color: 'var(--color-on-surface)' }}
          >
            Build consistent interfaces for any SaaS product
          </h2>
          <p
            className="text-center text-base mb-14 max-w-[480px] mx-auto"
            style={{ color: 'var(--color-on-surface-subtle-1)' }}
          >
            From dashboards to onboarding flows — Kvalt gives you the primitives to ship with confidence.
          </p>
        </FadeInSection>
      ...
      <div className="mx-auto max-w-[1280px] px-6">
        <FadeInSection>
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)', color: 'var(--color-on-surface)' }}
          >
            25+ components, infinite compositions
          </h2>
          <p
            className="text-center text-base mb-14 max-w-[480px] mx-auto"
            style={{ color: 'var(--color-on-surface-subtle-1)' }}
          >
            Every component is designed, documented, and tested. Full keyboard navigation, screen reader support, and motion built in.
          </p>
        </FadeInSection>
...
const FEATURES = [
  {
    ...
    description: 'Perceptually uniform color palettes. Every shade at the same lightness looks equally bright — no more muddy blues next to glowing greens.',
    icon: Palette,
    span: 'col-span-1 md:col-span-2',
  },
  {
    title: 'Spring Motion System',
    description: 'Physics-based springs for spatial motion, cubic easings for fades. Three semantic spring presets (snappy, default, playful) with a global speed dial.',
    icon: Zap,
    span: 'col-span-1',
  },
  {
    title: 'Dark Mode for Free',
    description: 'CSS variable architecture means components never reference colors directly. Toggle the dark class — everything switches instantly.',
    icon: Moon,
    span: 'col-span-1',
  },
  {
    title: 'WCAG AA Accessibility',
    description: 'Contrast ratios validated per-token, keyboard navigation on every interactive element, focus rings, reduced motion support, ARIA patterns.',
    icon: Shield,
    span: 'col-span-1 md:col-span-2',
  },
  {
    title: 'Character Theming',
    description: '53 CSS variables define a "character" — swap them all at once to completely re-skin the DS. Same components, different personality.',
    icon: Paintbrush,
    span: 'col-span-1 md:col-span-2',
  },
  {
    title: 'Spec Export Pipeline',
    description: 'Export component specs with all motion, interaction, and token details so your FE team can reproduce them in any framework.',
    icon: ExternalLink,
    span: 'col-span-1',
  },
];
      ...
      <div className="mx-auto max-w-[1280px] px-6">
        <FadeInSection>
          <h2
            ...
            style={{ fontFamily: 'var(--font-display)', color: 'var(--color-on-surface)' }}
          >
            Powerful foundations for product teams
          </h2>
          <p
            className="text-center text-base mb-14 max-w-[520px] mx-auto"
            style={{ color: 'var(--color-on-surface-subtle-1)' }}
          >
            Not just components — a complete system of color science, motion physics, accessibility, and theming.
          </p>
        </FadeInSection>
...
const STATS = [
  ...
  { value: '72', label: 'Color tokens' },
  { value: '9', label: 'Shadow tokens' },
  { value: '6', label: 'Motion presets' },
  { value: '20+', label: 'Doc pages' },
...
const FAQS = [
  {
    q: 'What tech stack does Kvalt use?',
    a: 'React 19, TypeScript 5.9, Tailwind CSS 3, Motion 12 (formerly Framer Motion), and Vite 8. Icons come from Lucide React.',
  },
  {
    q: 'How does the color system work?',
    a: 'All palettes are HSLUV-based — perceptually uniform across hues. 6 palettes × 12 shades, mapped to semantic CSS variables that automatically switch between light and dark themes.',
  },
  {
    q: 'Can I use Kvalt in my own project?',
    a: 'Kvalt is currently a reference implementation and learning resource. NPM packaging is on the roadmap. You can use the token system, specs, and component patterns as a foundation.',
  },
  {
    q: 'How does the motion system work?',
    a: 'Three spring presets (snappy, default, playful) handle spatial motion. Five duration tokens with cubic-bezier easings handle fades and color transitions. A global speed multiplier scales everything at once.',
  },
  {
    q: 'Is dark mode fully supported?',
    a: 'Yes. All components use semantic CSS variables — toggle the dark class on the html element and everything switches. Zero component changes needed.',
  },
  {
    q: 'What is Character theming?',
    a: 'A character is a set of 53 CSS variable overrides that completely re-skin the DS — colors, radius, shadows, typography. Same components, different visual personality.',
  },
];
    ...
    <FadeInSection>
      ...
      >
        <div className="mx-auto max-w-[720px] px-6 text-center">
          ...
          >
            Start building with Kvalt
          </h2>
          <p
            className="text-base mb-8 opacity-70"
            style={{ color: '#FFFFFF' }}
          >
            Explore the docs, browse components, and see the motion system in action.
          </p>
          <a
            href="#"
          ...
          >
            Explore the Docs <ArrowRight size={16} />
          </a>
        </div>
      </section>
    </FadeInSection>
...
const FOOTER_COLS = [
  {
    title: 'Foundations',
    items: ['Colors', 'Typography', 'Shadows', 'Border Radius', 'Icons', 'Illustrations'],
  },
  {
    title: 'Components',
    items: ['Button', 'Input', 'Modal', 'Table', 'Select', 'DatePicker', 'Tabs', 'More...'],
  },
  {
    title: 'Philosophy',
    items: ['Motion Guidelines', 'Tone of Voice', 'Accessibility', 'Design Principles', 'UX Copywriting'],
  },
  {
    title: 'Resources',
    items: ['Screen Vault', 'Docs', 'GitHub', 'Figma Source', 'Roadmap'],
  },
];
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              style={{ color: 'var(--color-on-surface-subtle-2)' }}
            >
              © 2026 Kvalt Design System. Built by Jan.
            </span>
          </div>
