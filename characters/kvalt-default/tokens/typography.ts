...
export const headlineScale = {
  '2xl': { fontSize: '42px', rem: '2.625', lineHeight: 1.2, letterSpacing: 0 },
  'xl':  { fontSize: '36px', rem: '2.25',  lineHeight: 1.2, letterSpacing: 0 },
  'l':   { fontSize: '28px', rem: '1.75',  lineHeight: 1.2, letterSpacing: 0 },
  'm':   { fontSize: '24px', rem: '1.5',   lineHeight: 1.2, letterSpacing: 0 },
  's':   { fontSize: '20px', rem: '1.25',  lineHeight: 1.2, letterSpacing: 0 },
} as const;

// ─── Body Text Scale (Inter) ──────────────────────────────────────────────────
// line-height: 1.5  |  letter-spacing varies (Figma values in px)

export const bodyScale = {
  'xl':  { fontSize: '18px', rem: '1.125',  lineHeight: 1.5, letterSpacing: '0'      },
  'l':   { fontSize: '16px', rem: '1',      lineHeight: 1.5, letterSpacing: '0.16px' },
  'm':   { fontSize: '14px', rem: '0.875',  lineHeight: 1.5, letterSpacing: '0.14px' },
  's':   { fontSize: '12px', rem: '0.75',   lineHeight: 1.5, letterSpacing: '0.48px' },
  'xs':  { fontSize: '10px', rem: '0.625',  lineHeight: 1.5, letterSpacing: '0.4px'  },
  '2xs': { fontSize: '8px',  rem: '0.5',    lineHeight: 1.5, letterSpacing: '0.32px' },
} as const;
...
//
// Headlines:  font-display text-headline-{s|m|l|xl|2xl} font-{medium|bold}
