#!/bin/zsh
# launch-bc4.sh — Open BC4 Omnichannel dev environment in one click
...
PROJ_DIR="$HOME/Dev/bc4-omnichannel"
...
tell application "Terminal"
    activate
    -- Dev server tab
    do script "cd ~/Dev/bc4-omnichannel/prototype && npm run dev"
end tell
APPLESCRIPT
...
tell application "Terminal"
    ...
    delay 0.3
    do script "cd ~/Dev/bc4-omnichannel && claude" in front window
end tell
APPLESCRIPT
